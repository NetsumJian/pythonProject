...
# from D:\python3.6\lib\site-packages\pandas\_libs\tslibs\timezones.cp36-win_amd64.pyd
# by generator 1.147
# no doc

# imports
import pytz as pytz  # D:\python3.6\lib\site-packages\pytz\__init__.py
...
class _dateutil_tzutc(__datetime.tzinfo):
    ...
    __dict__ = None  # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__doc__\': "\\n    This is a tzinfo object that represents the UTC time zone.\\n\\n    **Examples:**\\n\\n    .. doctest::\\n\\n        >>> from datetime import *\\n        >>> from dateutil.tz import *\\n\\n        >>> datetime.now()\\n        datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n        >>> datetime.now(tzutc())\\n        datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n        >>> datetime.now(tzutc()).tzname()\\n        \'UTC\'\\n\\n    .. versionchanged:: 2.7.0\\n        ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n        always return the same object.\\n\\n        .. doctest::\\n\\n            >>> from dateutil.tz import tzutc, UTC\\n            >>> tzutc() is tzutc()\\n            True\\n            >>> tzutc() is UTC\\n            True\\n    ", \'utcoffset\': <function tzutc.utcoffset at 0x000001E3731B49D8>, \'dst\': <function tzutc.dst at 0x000001E3731B4A60>, \'tzname\': <function tzutc.tzname at 0x000001E3731B4AE8>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x000001E3731B4B70>, \'fromutc\': <function tzutc.fromutc at 0x000001E3731B4C80>, \'__eq__\': <function tzutc.__eq__ at 0x000001E3731B4D08>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x000001E3731B4D90>, \'__repr__\': <function tzutc.__repr__ at 0x000001E3731B4E18>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __hash__ = None
...
class _pytz_BaseTzInfo(__datetime.tzinfo):
    ...
    _tzname = None
    _utcoffset = None
    __dict__ = None  # (!) real value is "mappingproxy({'__module__': 'pytz.tzinfo', '_utcoffset': None, '_tzname': None, 'zone': None, '__str__': <function BaseTzInfo.__str__ at 0x000001E372F75EA0>, '__dict__': <attribute '__dict__' of 'BaseTzInfo' objects>, '__weakref__': <attribute '__weakref__' of 'BaseTzInfo' objects>, '__doc__': None})"
...
__loader__ = None  # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001E372FB9B70>'

__pyx_capi__ = {
    'get_dst_info': None,  # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x000001E372FC5390>'
    'get_timezone': None,
    # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x000001E372FC52D0>'
    'get_utcoffset': None,
    # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *)" at 0x000001E372FC5330>'
    'is_fixed_offset': None,  # (!) real value is '<capsule object "int (PyObject *)" at 0x000001E372FC5360>'
    'is_tzlocal': None,  # (!) real value is '<capsule object "int (PyObject *)" at 0x000001E372FC5210>'
    'is_utc': None,
    # (!) real value is '<capsule object "int (PyObject *, int __pyx_skip_dispatch)" at 0x000001E372FC51E0>'
    'maybe_get_tz': None,
    # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x000001E372FC5300>'
    'treat_tz_as_dateutil': None,  # (!) real value is '<capsule object "int (PyObject *)" at 0x000001E372FC5270>'
    'treat_tz_as_pytz': None,  # (!) real value is '<capsule object "int (PyObject *)" at 0x000001E372FC5240>'
    'tz_compare': None,
    # (!) real value is '<capsule object "int (PyObject *, PyObject *, int __pyx_skip_dispatch)" at 0x000001E372FC52A0>'
}

__spec__ = None  # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timezones', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001E372FB9B70>, origin='D:\\\\python3.6\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\timezones.cp36-win_amd64.pyd')"

__test__ = {
    'tz_standardize (line 326)': '\n    If the passed tz is a pytz timezone object, "normalize" it to the a\n    consistent version\n\n    Parameters\n    ----------\n    tz : tz object\n\n    Returns:\n    -------\n    tz object\n\n    Examples:\n    --------\n    >>> tz\n    <DstTzInfo \'US/Pacific\' PST-1 day, 16:00:00 STD>\n\n    >>> tz_standardize(tz)\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n\n    >>> tz\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n\n    >>> tz_standardize(tz)\n    <DstTzInfo \'US/Pacific\' LMT-1 day, 16:07:00 STD>\n\n    >>> tz\n    dateutil.tz.tz.tzutc\n\n    >>> tz_standardize(tz)\n    dateutil.tz.tz.tzutc\n    ',
}
